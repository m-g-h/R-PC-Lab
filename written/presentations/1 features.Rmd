...
The most commonly used feature of a probability distribution is the *expected value*. It splits the probability under the *pdf* in half. It is calculated as a weighted average of the random variable:
...
The green lines indicate a standard normal distribution with $\mu = 0$ and $\sigma = 1$. Our simulated varaible clearly deviates from it. 

---

If we now transform $X$ according to the formula above, the result yields:
